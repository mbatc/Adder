...
namespace adder {
  namespace compiler {
    namespace builtin {
      ...
      bool cmp_int_int(program_builder* program, uint8_t cmpBits, bool invert) {
        auto const a = program->find_value_by_identifier("a");
        auto const b = program->find_value_by_identifier("b");
        if (!a.has_value() || !b.has_value()) {
          return false;
      ...
      bool eq_int_int(program_builder * program) {
        return cmp_int_int(program, vm::cmp_eq_bit, false);
      }
      
      bool ne_int_int(program_builder * program) {
        return cmp_int_int(program, vm::cmp_eq_bit, true);
      }

      bool gt_int_int(program_builder * program) {
        return cmp_int_int(program, vm::cmp_gt_bit, false);
      }
      ...
      bool le_int_int(program_builder * program) {
        return cmp_int_int(program, vm::cmp_gt_bit, true);
      }
      ...
      bool bool_assign_bool(program_builder * program) {
        auto const a = program->find_value_by_identifier("a");
        auto const b = program->find_value_by_identifier("b");
        if (!a.has_value() || !b.has_value()) {
          return false;
    ...
    void declare_integer(ast* tree, expr::block *scope, type_primitive primitive) {
      ...
      scope->statements.insert(
        scope->statements.end(),
        {
          ...
          declare_binary_operator(tree, expr::operator_type::equal, boolType, valueType, valueType, builtin::eq_int_int),
          declare_binary_operator(tree, expr::operator_type::not_equal, boolType, valueType, valueType, builtin::ne_int_int),
          declare_binary_operator(tree, expr::operator_type::greater_equal, boolType, valueType, valueType, builtin::ge_int_int),
          declare_binary_operator(tree, expr::operator_type::less_equal, boolType, valueType, valueType, builtin::le_int_int),
          declare_binary_operator(tree, expr::operator_type::less, boolType, valueType, valueType, builtin::lt_int_int),
          declare_binary_operator(tree, expr::operator_type::greater, boolType, valueType, valueType, builtin::gt_int_int),
        }
      );
    }
    ...
    void declare_boolean(ast* tree, expr::block* scope) {expr::type_name selfTypeName;
      ...
      scope->statements.insert(
        scope->statements.end(),
        {
          declare_initializer(tree, refType, get_primitive_type_name(type_primitive::bool_), builtin::init_bool_bool),
          
          declare_binary_operator(tree, expr::operator_type::assign,   refType, refType, valueType, builtin::bool_assign_bool),
          // declare_binary_operator(tree, expr::operator_type::add,      valueType, builtin::add_int_int),
          // declare_binary_operator(tree, expr::operator_type::minus,    valueType, builtin::sub_int_int),
          // declare_binary_operator(tree, expr::operator_type::divide,   valueType, builtin::div_int_int),
          // declare_binary_operator(tree, expr::operator_type::multiply, valueType, builtin::mul_int_int),
